...
{
    static public class MaterialLoader
    {
        ...
        public static UnityEngine.Material Load(ByteBuffer bb,Func<string,Shader> funcShader,Func<string,Texture> funcTexture)
        {
                    ...
                    case ShaderPropertyType.TexEnv:
                        {
                            ...
                            Texture texture = funcTexture(t.Name);
