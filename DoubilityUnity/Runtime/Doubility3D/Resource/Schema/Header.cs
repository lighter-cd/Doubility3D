...
public sealed class Header : Table {
  ...
  public Context Context { get { int o = __offset(6); return o != 0 ? (Context)bb.GetInt(o + bb_pos) : Context.Unknown; } }
  ...
  public static void AddContext(FlatBufferBuilder builder, Context context) { builder.AddInt(1, (int)context, 0); }
